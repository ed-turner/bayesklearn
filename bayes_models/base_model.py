...
#modelcode
from assemble_model_code import assembleModelCode
...
class SSModelBase():
    ...
    def fit(self, df):
        ...
        model_code = assembleModelCode( cat_cols = cat_cols, is_regression = self.is_reg )
...
class SSClassifier(SSModelBase):
    ...
    def predict_proba(self, test_df):
        ...
        return super(SSClassifier, self).predict(test_df)
